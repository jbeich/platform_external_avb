...
hashtree and FEC at runtime. If this is done all of the hashtree and FEC data is
set to zero except for the first eight bytes which is set to the magic
`ZeRoHaSH`. Applications can use this to detect if recalculation is needed.
