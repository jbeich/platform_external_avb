...
import (
	...
	"android.googlesource.com/platform/external/avb/tools/transparency/verify/internal/checkpoint"
	"android.googlesource.com/platform/external/avb/tools/transparency/verify/internal/tiles"
