...
use crate::{ops::Result, IoError, Ops, PublicKeyForPartitionInfo};
...
pub struct FakePartition {
    pub contents: Vec<u8>, // Partition contents
    pub preloaded: bool,   // Whether it should report as preloaded or not
    #[cfg(feature = "uuid")]
    pub uuid: Uuid, // Partition UUID
}
