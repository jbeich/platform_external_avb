...
use crate::{
    ...
    error::{
        slot_verify_enum_to_result, vbmeta_verify_enum_to_result, AvbGetPropertyError,
        AvbGetPropertyResult, SlotVerifyError, SlotVerifyNoDataResult, SlotVerifyResult,
        VbmetaVerifyResult,
    },
    ops, Ops,
};
...
impl VbmetaData {
    ...
    ///
    /// # Returns
    /// Byte array with property data or AvbGetPropertyError
    pub fn get_property(&self, key: &str) -> AvbGetPropertyResult<&[u8]> {
        ...
        match unsafe {
            ...
            result if result.is_null() => Err(AvbGetPropertyError::NotFound),
            // SAFETY:
