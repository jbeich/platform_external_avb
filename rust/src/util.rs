...
pub(crate) unsafe fn cstr_to_str<'a, L>(
    ptr: *const c_char,
    lifetime_: &'a L,
...
///
/// All pointers provided by libavb meet this criteria.
pub(crate) unsafe fn buffer_to_slice<'a, L>(
    ptr: *const u8,
    size: usize,
    lifetime_: &'a L,
) -> Result<&'a [u8], IoError> {
...
///
/// All pointers provided by libavb meet this criteria.
pub(crate) unsafe fn buffer_to_slice_mut<'a, L>(
    ptr: *mut u8,
    size: usize,
    lifetime_: &'a L,
...
///
/// All pointers provided by libavb meet this criteria.
pub(crate) unsafe fn write_checked<T>(ptr: *mut T, value: T) -> Result<(), IoError> {
    if ptr.is_null() {
        return Err(IoError::Io);
    }
