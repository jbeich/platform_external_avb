...
use avb::{
    atx_validate_vbmeta_public_key, AtxOps, AtxPermanentAttributes, IoError, IoResult, Ops,
...
pub enum FakeVbmetaKey {
    ...
    /// ATX validation using the permanent attributes.
    Atx,
...
impl<'a> TestOps<'a> {
    ...
    fn validate_fake_key(
        ...
        match fake_key {
            ...
            FakeVbmetaKey::Atx => {
                // ATX: forward to the ATX helper function.
