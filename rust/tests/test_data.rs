...
// ATX test data.
pub const TEST_ATX_PERMANENT_ATTRIBUTES_PATH: &str = "data/atx_permanent_attributes.bin";
pub const TEST_ATX_VBMETA_PATH: &str = "test_vbmeta_atx.img";

// The ATX test keys were both generated with rollback version 42.
pub const TEST_ATX_PIK_VERSION: u64 = 42;
pub const TEST_ATX_PSK_VERSION: u64 = 42;
